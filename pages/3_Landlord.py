...
with placeholder_map.container():
    ...
    with col2:
        st.write('\n')
        st.markdown("""
                # Welcome to <span style="color:tomato">housing_crawler</span> dashboard!
                ## Have you ever wondered if what you pay for your room in a WG (flatshare) is fair according to the market? I've collected thousands of WG ads from wg-gesucht.de to answer that question for you.
                # You'll find in this dashboard everything you want to know about WG prices in Germany.
                For technical information, please check [GitHub](https://github.com/chvieira2/housing_crawler).
                """, unsafe_allow_html=True)
